...
import { deleteTemplate, listTemplates, uploadTemplate, type MenuTemplate } from "./templatesApi";

/** Gestión de plantillas (archivos en public/templates), dentro de Configuración. */
export function MenuTemplatesSettings() {
  ...
  const onDelete = async (t: MenuTemplate) => {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-sm font-medium">Plantillas del menú</p>
      ...
      <p className="text-xs text-neutral-400">
        Se guardan como archivos en <code className="rounded bg-neutral-100 px-1">public/templates</code> (menu-dia1.png, menu-dia2.png…).
      </p>
      ...
      {templates.length === 0 ? (
        <p className="rounded-xl border border-dashed border-neutral-200 bg-neutral-50 p-4 text-center text-xs text-neutral-400">
          No hay plantillas en public/templates todavía.
        </p>
      ) : (
